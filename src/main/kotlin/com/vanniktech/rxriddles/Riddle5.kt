...
object Riddle5 {
     ...
     *
     * Use case: Two input fields in a calculator that want to be summed up and the result should be updated every time one of the inputs change.
     */
    fun solve(first: Observable<Int>, second: Observable<Int>): Observable<Int> {
        ...
        //     return Observable.combineLatest(first, second) {v1: Int, v2: Int -> v1+v2}
    }
}
